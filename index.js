...
app.use(express.static(path.join(__dirname, "views"), { maxAge: "1d", etag: true }));
...
const localUserStore = require("./db/userregistrations-store");
    ...
    try {
      ...
      if (password) {
        if (
          ...
          mongoRegistration.password = await bcrypt.hash(password, 15);
          changeLog.push({
            field: "password",
